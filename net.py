...
from nanoGPT_linear import GPT, GPTConfig
...
class LinearTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        # customized method of passing forward with embeddings 
        transformer_outputs, _ = self.transformer.forward_with_embeddings(stacked_inputs)
